...
public class EmailNotificationLogic {
    ...
    /**
     * Sends an email with the specified subject, Twitch streamer's name, and execution time.
     *
     * @param subject The subject of the email.
     * @param twitchStreamer The name of the Twitch streamer.
     * @param executionTime The execution time related to the task.
     */
    ...
    /**
     * Creates the email notification message
     * @param twitchStreamer The streamer processed
     * @param executionTime How much time did the execution last
